...
function main() {
    ...
    const webui = new WebUI(config, agent, reloadPlugin, adapter, { addonMgr, configLoader, addonCenter });
    webui.start();
    ...
    return { client, onChatHandle, onPlayerJoinHandle, onPlayerLeftHandle, tickMonitor, addonMgr, aliveFlag, webui, config };
}
